      ...
      <div className="px-4 pt-5 pb-24">
        {loading ? (
          ...
          <div className="space-y-4 max-w-lg mx-auto">
            ...
            {/* Driver Info — shows only when a driver is assigned */}
            {!['pending', 'rejected', 'completed'].includes(order.status) && order.driver_name && (
              <div
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative flex-shrink-0 w-16 h-16 flex items-center justify-center"
                    ...
                    <img
                      src="/driver-cartoon.svg"
                      alt=""
                      className="w-16 h-16 relative z-10 rounded-full"
