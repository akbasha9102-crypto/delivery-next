                ...
                {extras.map(e => {
                  ...
                  return (
                    <button
                      ...
                      style={on
                        ? (dark ? { backgroundColor: 'var(--admin-accent-dark-soft)', borderColor: 'var(--admin-accent-dark)' } : { backgroundColor: 'var(--admin-accent-light-bg-soft)', borderColor: 'var(--admin-accent-light-border)' })
