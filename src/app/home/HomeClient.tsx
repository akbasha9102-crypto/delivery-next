...
import { Plus, Minus, ShoppingBag, ShoppingCart, Trash2, MapPin, MessageCircle, ChevronDown, ChevronRight, ChevronLeft, Check, X } from 'lucide-react';
                    ...
                    return (
                      <motion.div
                        ...
                        <div className={`flex flex-col flex-1 ${isBestSellers ? 'p-2' : 'p-3 sm:p-6'}`}>
                          <p className={`font-black text-gray-900 dark:text-slate-100 text-right leading-tight ${isBestSellers ? 'text-base sm:text-lg mb-1 line-clamp-2' : 'text-sm sm:text-xl mb-1 sm:mb-2'}`}>
                            {item.name}
                          </p>
