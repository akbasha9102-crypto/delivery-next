...
// نفس شكل src/app/super-admin/login/page.tsx تماماً، لكن يرسل لنفس
// endpoint المشترك /api/super-admin/auth (قرار مؤكَّد: كلمة سر سوبر أدمن
// واحدة تخدم اللوحتين، فقط عبر صفحتي دخول مختلفتين) ويحوّل لداشبورد
// dddmart بدل داشبورد المطاعم بعد النجاح.
export default function SuperAdminDddmartLogin() {
  ...
  const signIn = async () => {
    ...
    if (res.ok) {
      router.replace('/super-admin-dddmart/dashboard');
    } else {
    ...
    <div className="min-h-screen bg-[#0f0f1a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">لوحة تحكم متاجر dddmart</p>
        </div>
